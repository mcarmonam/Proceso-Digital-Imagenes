...
public class Interfaz extends Application {
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        ...
        primaryStage.setTitle("Proceso Digital de Imagenes: Practica04");
    ...
    public HBox addMenu(Stage primaryStage, BorderPane bp, GridPane grid){
      ...
      MenuItem nim = new MenuItem("Selecionar Imagen");
      ...
      MenuItem ebe = new MenuItem("Encontrar Bordes (todas)");
      ...
      r3.setOnAction(new EventHandler<ActionEvent>(){
          public void handle(ActionEvent t) {
            ImageView imv = (ImageView) grid.getChildren().get(0);
            Image im = imv.getImage();
            ImageView iv = new ImageView(conv.emboss3(im));
            iv.setFitWidth(500);
            iv.setPreserveRatio(true);
            grid.getChildren().remove(1);
            grid.add(iv,1,0);
      ...
      r5.setOnAction(new EventHandler<ActionEvent>(){
          public void handle(ActionEvent t) {
            ImageView imv = (ImageView) grid.getChildren().get(0);
            Image im = imv.getImage();
            ImageView iv = new ImageView(conv.emboss5(im));
            iv.setFitWidth(500);
            iv.setPreserveRatio(true);
            grid.getChildren().remove(1);
            grid.add(iv,1,0);
    ...
    flm.getItems().addAll(filtromc,filtroac,filtrombn,filtroabn, filtroml,filtromlc,filtromlbn,filtrod,filtron);
      ...
      mbar.getMenus().addAll(mfile,mfilt,convm,flm,mdam);
